...
const SidebarProvider = (t0)=>{
    ...
    if ($[0] !== "200fe4675ee68a5a9a704f239f9d9540f74d9e3ff0892a458775cf571b3833b0") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "200fe4675ee68a5a9a704f239f9d9540f74d9e3ff0892a458775cf571b3833b0";
    }
    const { children } = t0;
    ...
    let t5;
    if ($[7] !== children || $[8] !== t4) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SidebarContext.Provider, {
            value: t4,
            children: children
        }, void 0, false, {
...
_s(SidebarProvider, "LlqjeW0k21YzWMbZFsCby6i1BGI=", false, function() {
    return [
...
const Navbar = ()=>{
    ...
    if ($[0] !== "6f93125e1340ba7d9640370c3d15fdd70b47858855dcfd28628fcc1edb97f3af") {
        for(let $i = 0; $i < 46; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6f93125e1340ba7d9640370c3d15fdd70b47858855dcfd28628fcc1edb97f3af";
    }
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ()=>{
            ...
            getUser();
            const { data: t5 } = supabase.auth.onAuthStateChange((_event, session)=>{
    ...
    const t4 = `sticky top-0 z-50 w-full transition-all duration-300 h-20 ${scrolled ? "bg-background/95 backdrop-blur-md" : "bg-background"}`;
    const t5 = `hidden lg:flex items-center h-full transition-all duration-300 ease-in-out ${isOpen ? "w-64 justify-start pl-[42px]" : "w-16 justify-center"}`;
    const t6 = isOpen ? "Close Sidebar" : "Open Sidebar";
    let t7;
    ...
    let t13;
    if ($[17] !== handleSignOut || $[18] !== isLoadingUser || $[19] !== user) {
    ...
    const t16 = `md:hidden absolute top-full left-0 w-full bg-background border-b border-border shadow-2xl transition-all duration-300 ease-in-out z-[100] ${mobileMenuOpen ? "max-h-[90vh] opacity-100 overflow-y-auto" : "max-h-0 opacity-0 pointer-events-none"}`;
    let t17;
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        item.isDevelopment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-[9px] font-black uppercase text-amber-500 mt-0.5 tracking-[0.1em]",
                                ...
                                !item.isDevelopment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$down$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronDown$3e$__["ChevronDown"], {
                                    size: 14,
    ...
    let t21;
    if ($[30] !== handleSignOut || $[31] !== isLoadingUser || $[32] !== user) {
...
_s(Navbar, "FjBM1TsdrqQvGNfk6edeFi2zSac=", false, function() {
    return [
...
const PinterestIcon = (t0)=>{
    ...
    if ($[0] !== "763b5a555a356efca59baae7df0d2d2fa413796857cf2ae48cc6aa2d6c15b246") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "763b5a555a356efca59baae7df0d2d2fa413796857cf2ae48cc6aa2d6c15b246";
    }
    const { size: t1 } = t0;
...
const Sidebar = ()=>{
    ...
    const t1 = `h-[calc(100vh-5rem)] sticky top-20 hidden lg:block bg-zinc-900/50 transition-all duration-300 ease-in-out ${isOpen ? "w-64" : isHome ? "w-0 opacity-0 overflow-hidden" : "w-16"}`;
    ...
    if ($[4] !== isOpen || $[5] !== pathname) {
        t6 = menuItems.map((item)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                href: item.isDevelopment ? "#" : item.href,
                className: `group flex items-center transition-all duration-300 border ${isOpen ? "justify-between px-4 py-2 rounded-lg" : "justify-center h-12 w-full border-transparent"} ${isActive ? "bg-foreground text-background border-foreground shadow-lg shadow-foreground/10" : "hover:bg-zinc-100/10 dark:hover:bg-zinc-800/50 border-transparent"} ${item.isDevelopment ? "opacity-40 grayscale cursor-not-allowed" : ""}`,
                ...
                children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    item.isDevelopment && !isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute top-0 right-0 w-2 h-2 bg-amber-500 rounded-full border border-black animate-pulse"
                                    }, void 0, false, {
                                        fileName: "[project]/components/Sidebar.tsx",
                                        lineNumber: 113,
                                        columnNumber: 766
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: [
                                    item.name,
                                    item.isDevelopment && isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-[8px] font-black uppercase text-amber-500 mt-0.5 tracking-[0.1em]",
                                        children: "Stay Updated"
                                    }, void 0, false, {
                                        fileName: "[project]/components/Sidebar.tsx",
                                        lineNumber: 113,
                    ...
                    isOpen && !item.isDevelopment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$right$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronRight$3e$__["ChevronRight"], {
                        size: 14,
...
//# sourceMappingURL=_49249963._.js.map