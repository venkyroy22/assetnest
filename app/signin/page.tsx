    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center py-12 md:py-20 px-6 bg-background relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full z-0 opacity-20">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-zinc-800 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-zinc-700/30 rounded-full blur-[150px] animate-pulse delay-700" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-foreground/5 border border-foreground/10 mb-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-foreground">Welcome Back</span>
                    </div>
                    <h1 className="text-3xl font-black uppercase tracking-tight text-white leading-none">
                        Sign In to <span className="bg-[linear-gradient(to_right,#757F9A,#D7DDE8,#757F9A,#D7DDE8,#757F9A)] bg-clip-text text-transparent">AssetNest</span>
                    </h1>
                    <p className="mt-3 text-zinc-500 text-sm font-medium">Access your curated tools and premium creative assets.</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-zinc-600 hover:text-white transition-colors">Forgot?</Link>
                            </div>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <p className="mt-8 text-center text-zinc-500 text-xs font-medium">
                    ...
                    <Link href="/signup" className="text-white hover:underline underline-offset-4 decoration-zinc-700 font-bold transition-all">
                        Create an account
                    </Link>
                </p>
            </div>
