...
function VerticalHighlightList() {
  const items = [
    ...
    { name: "CSS Gradient Maker", desc: "Design & copy gorgeous color transitions", href: "/tools/css-gradient" },
    { name: "SVG Background Patterns", desc: "Generate custom repeating vector art", href: "/tools/svg-patterns" },
...
export default function Home() {
  ...
  const creativeTools = [
    ...
    { name: "Grandmaster Chess", href: "/tools/chess", icon: Crown, image: "https://cdn.streamlet.in/6a0fe18049e42bdad2a338ff/images/chess-1779426374452.webp" },
