            ...
            <Container>
                <div className="max-w-4xl mx-auto bg-[#1c1c1c] border border-white/[0.05] rounded-[2.5rem] p-8 sm:p-12 md:p-16 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-12 text-[#f0ede8]">Terms of Service</h1>
                        ...
                        <div className="space-y-12 text-zinc-400 leading-relaxed text-[15px] sm:text-[17px]">
                            ...
                            <section className="bg-[#1c1c1c]/30 p-6 sm:p-8 rounded-3xl border border-white/[0.06]">
                                <h2 className="text-xl sm:text-2xl font-bold tracking-wide text-[#f0ede8] mb-4">1. Acceptance of Terms</h2>
                                <p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                                <section>
                                    <h2 className="text-xl sm:text-2xl font-bold tracking-wide text-[#f0ede8] mb-4">2. Use License</h2>
                                    <p>
                                ...
                                <section>
                                    <h2 className="text-xl sm:text-2xl font-bold tracking-wide text-[#f0ede8] mb-4">3. Local Execution</h2>
                                    <p>
                                ...
                                <section>
                                    <h2 className="text-xl sm:text-2xl font-bold tracking-wide text-[#f0ede8] mb-4">4. Disclaimers</h2>
                                    <p>
                                ...
                                <section>
                                    <h2 className="text-xl sm:text-2xl font-bold tracking-wide text-[#f0ede8] mb-4">5. Limitations</h2>
                                    <p>
