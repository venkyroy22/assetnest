...
export const metadata: Metadata = {
    ...
    description: "Test and improve your typing speed (WPM) and accuracy with our premium typing speed test. Get real-time stats, detailed results, and professional feedback.",
